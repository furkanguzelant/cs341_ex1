const SCENES = [
  {
    ...
    spheres: [{ center: [0.0, 1.5, 4.0], radius: 1.0, material: "mirror" }],
    planes: [
      { center: [0.0, -1, 0], normal: [0, 1, 0], material: "white" }, // bottom
      {
        center: [-2, -1, 0],
        normal: [0.3939193, 0.91914503, 0],
        material: "green",
      }, // left
      {
        center: [2, -1, 0],
  ...
  },
  {
    name: "creature",
    camera: {
      position: [6.301, 9.207, 4.061],
      up: [-0.167, -0.209, 0.964],
      target: [0.291, 1.674, 1.389],
      fov: 45,
    },
    ...
    planes: [
      {
        center: [-5.624, 0.917, 8.321],
        normal: [0.999, 0.0, 0.043],
        material: "default",
      },
    ],
    cylinders: [
      {
        center: [0.0, -0.726, 0.0],
        axis: [0.0, -1.0, -0.0],
        height: 3.463,
        radius: 1.0,
        material: "fuzzy",
      ...
      {
        center: [0.0, 1.754, 1.159],
        axis: [0.0, -0.538, -0.843],
        height: 1.418,
        radius: 0.409,
        material: "fuzzy",
      },
      {
        center: [0.667, 1.957, 3.476],
        axis: [-0.241, 0.551, -0.799],
        height: 0.791,
        radius: 0.228,
        material: "default",
      },
      {
        center: [-0.674, 1.934, 3.473],
        axis: [-0.241, -0.551, 0.799],
        height: 0.791,
        radius: 0.228,
        material: "default",
      ...
      {
        center: [0.762, -2.491, -1.279],
        axis: [0.172, -0.087, -0.981],
        height: 1.53,
        radius: 0.193,
        material: "default",
      },
      {
        center: [-0.708, -2.49, -1.266],
        axis: [0.172, 0.087, 0.981],
        height: 1.53,
        radius: 0.193,
        material: "default",
      ...
      {
        center: [-0.708, 1.156, -1.266],
        axis: [0.172, -0.155, 0.973],
        height: 1.53,
        radius: 0.193,
        material: "default",
      },
      {
        center: [0.762, 1.158, -1.279],
        axis: [0.172, 0.155, -0.973],
        height: 1.53,
        radius: 0.193,
        material: "default",
  ...
  },
  {
    ...
    lights: [{ position: [0, 0, -0.2], color: [1.0, 0.4, 0.2] }],
...
SCENES.push({
  ...
  cylinders: [0, 1, 2, 3, 4, 5, 6, 7].map((i) => {
    ...
    const r = 3;
    return {
      center: [r * Math.cos(a), r * Math.sin(a), 0],
      axis: [0, 0, 1],
      radius: 0.25,
      height: 4,
      material: "shiny",
  ...
  planes: [{ center: [0, 0, -1], normal: [0, 0, 1], material: "floor" }],
});
...
SCENES.push({
  ...
  lights: [{ position: [0.3, 0.35, -0.15], color: [0.9, 0.8, 0.7] }],
  spheres: [
